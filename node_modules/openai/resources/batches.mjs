...
export class Batches extends APIResource {
    ...
    retrieve(batchID, options) {
        return this._client.get(path `/batches/${batchID}`, resolveResourceRequestOptions(options, (options) => ({ ...options, __security: { bearerAuth: true } })));
    }
    list(query = {}, options) {
        ...
        query = query;
        return this._client.getAPIList('/batches', (CursorPage), resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
            __security: { bearerAuth: true },
        })));
    ...
    cancel(batchID, options) {
        return this._client.post(path `/batches/${batchID}/cancel`, resolveResourceRequestOptions(options, (options) => ({ ...options, __security: { bearerAuth: true } })));
    }
}
