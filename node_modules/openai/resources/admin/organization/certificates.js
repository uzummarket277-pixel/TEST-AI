...
class Certificates extends resource_1.APIResource {
     ...
     */
    create(body, options) {
        return this._client.post('/organization/certificates', resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
    ...
    retrieve(certificateID, query = {}, options) {
        ...
        query = query;
        return this._client.get((0, path_1.path) `/organization/certificates/${certificateID}`, resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    update(certificateID, body, options) {
        return this._client.post((0, path_1.path) `/organization/certificates/${certificateID}`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    list(query = {}, options) {
        ...
        query = query;
        return this._client.getAPIList('/organization/certificates', (pagination_1.ConversationCursorPage), resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    delete(certificateID, options) {
        return this._client.delete((0, path_1.path) `/organization/certificates/${certificateID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
    ...
    activate(body, options) {
        return this._client.getAPIList('/organization/certificates/activate', (pagination_1.Page), resolveResourceRequestOptions(options, (options) => ({
            body,
            method: 'post',
            ...options,
            __security: { adminAPIKeyAuth: true },
    ...
    deactivate(body, options) {
        return this._client.getAPIList('/organization/certificates/deactivate', (pagination_1.Page), resolveResourceRequestOptions(options, (options) => ({
            body,
            method: 'post',
            ...options,
            __security: { adminAPIKeyAuth: true },
