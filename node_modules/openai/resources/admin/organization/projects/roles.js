...
class Roles extends resource_1.APIResource {
    ...
    create(projectID, body, options) {
        return this._client.post((0, path_1.path) `/projects/${projectID}/roles`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
    ...
    retrieve(roleID, params, options) {
        ...
        return this._client.get((0, path_1.path) `/projects/${project_id}/roles/${roleID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
    ...
    update(roleID, params, options) {
        ...
        return this._client.post((0, path_1.path) `/projects/${project_id}/roles/${roleID}`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    list(projectID, query = {}, options) {
        ...
        query = query;
        return this._client.getAPIList((0, path_1.path) `/projects/${projectID}/roles`, (pagination_1.NextCursorPage), resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    delete(roleID, params, options) {
        const { project_id } = params;
        return this._client.delete((0, path_1.path) `/projects/${project_id}/roles/${roleID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
