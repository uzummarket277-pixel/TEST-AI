...
export class Roles extends APIResource {
    ...
    create(projectID, body, options) {
        return this._client.post(path `/projects/${projectID}/roles`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
    ...
    retrieve(roleID, params, options) {
        ...
        return this._client.get(path `/projects/${project_id}/roles/${roleID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
    ...
    update(roleID, params, options) {
        ...
        return this._client.post(path `/projects/${project_id}/roles/${roleID}`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    list(projectID, query = {}, options) {
        ...
        query = query;
        return this._client.getAPIList(path `/projects/${projectID}/roles`, (NextCursorPage), resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    delete(roleID, params, options) {
        const { project_id } = params;
        return this._client.delete(path `/projects/${project_id}/roles/${roleID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
