...
export declare class SpendAlerts extends APIResource {
     ...
     * ```
     */
    list(projectID: string, query?: (SpendAlertListParams & ({
    ...
    } | null | undefined)) | null | undefined, options?: RequestOptions): PagePromise<ProjectSpendAlertsPage, ProjectSpendAlert>;
