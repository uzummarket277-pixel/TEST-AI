...
class ModelPermissions extends resource_1.APIResource {
    ...
    retrieve(projectID, options) {
        return this._client.get((0, path_1.path) `/organization/projects/${projectID}/model_permissions`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
    ...
    update(projectID, body, options) {
        return this._client.post((0, path_1.path) `/organization/projects/${projectID}/model_permissions`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    delete(projectID, options) {
        return this._client.delete((0, path_1.path) `/organization/projects/${projectID}/model_permissions`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
