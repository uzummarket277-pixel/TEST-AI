...
export declare class ServiceAccounts extends APIResource {
     ...
     * ```
     */
    list(projectID: string, query?: (ServiceAccountListParams & ({
    ...
    } | null | undefined)) | null | undefined, options?: RequestOptions): PagePromise<ProjectServiceAccountsPage, ProjectServiceAccount>;
