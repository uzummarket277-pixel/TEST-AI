...
class DataRetention extends resource_1.APIResource {
    ...
    retrieve(projectID, options) {
        return this._client.get((0, path_1.path) `/organization/projects/${projectID}/data_retention`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
    ...
    update(projectID, body, options) {
        return this._client.post((0, path_1.path) `/organization/projects/${projectID}/data_retention`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
