...
export declare class RateLimits extends APIResource {
     ...
     * ```
     */
    listRateLimits(projectID: string, query?: (RateLimitListRateLimitsParams & ({
    ...
    } | null | undefined)) | null | undefined, options?: RequestOptions): PagePromise<ProjectRateLimitsPage, ProjectRateLimit>;
    listRateLimits(projectID: string, options?: {
