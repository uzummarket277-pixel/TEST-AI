...
export class SpendAlerts extends APIResource {
    ...
    create(projectID, body, options) {
        return this._client.post(path `/organization/projects/${projectID}/spend_alerts`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
    ...
    retrieve(alertID, params, options) {
        ...
        return this._client.get(path `/organization/projects/${project_id}/spend_alerts/${alertID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
    ...
    update(alertID, params, options) {
        ...
        return this._client.post(path `/organization/projects/${project_id}/spend_alerts/${alertID}`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    list(projectID, query = {}, options) {
        ...
        query = query;
        return this._client.getAPIList(path `/organization/projects/${projectID}/spend_alerts`, (ConversationCursorPage), resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    delete(alertID, params, options) {
        const { project_id } = params;
        return this._client.delete(path `/organization/projects/${project_id}/spend_alerts/${alertID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
