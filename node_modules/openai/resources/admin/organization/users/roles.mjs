...
export class Roles extends APIResource {
    ...
    create(userID, body, options) {
        return this._client.post(path `/organization/users/${userID}/roles`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
    ...
    retrieve(roleID, params, options) {
        ...
        return this._client.get(path `/organization/users/${user_id}/roles/${roleID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
    list(userID, query = {}, options) {
        ...
        query = query;
        return this._client.getAPIList(path `/organization/users/${userID}/roles`, (NextCursorPage), resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    delete(roleID, params, options) {
        const { user_id } = params;
        return this._client.delete(path `/organization/users/${user_id}/roles/${roleID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
