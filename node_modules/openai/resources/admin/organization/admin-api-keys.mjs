...
export class AdminAPIKeys extends APIResource {
     ...
     */
    create(body, options) {
        return this._client.post('/organization/admin_api_keys', resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
    ...
    retrieve(keyID, options) {
        return this._client.get(path `/organization/admin_api_keys/${keyID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
    list(query = {}, options) {
        ...
        query = query;
        return this._client.getAPIList('/organization/admin_api_keys', (CursorPage), resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    delete(keyID, options) {
        return this._client.delete(path `/organization/admin_api_keys/${keyID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
