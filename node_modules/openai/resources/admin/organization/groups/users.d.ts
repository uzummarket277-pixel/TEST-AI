...
export declare class Users extends APIResource {
     ...
     * ```
     */
    list(groupID: string, query?: (UserListParams & ({
    ...
    } | null | undefined)) | null | undefined, options?: RequestOptions): PagePromise<OrganizationGroupUsersPage, OrganizationGroupUser>;
