...
export class Certificates extends APIResource {
    ...
    retrieve(certificateID, query = {}, options) {
        ...
        query = query;
        return this._client.get(path `/organization/certificates/${certificateID}`, resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    update(certificateID, body, options) {
        return this._client.post(path `/organization/certificates/${certificateID}`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    list(query = {}, options) {
        ...
        query = query;
        return this._client.getAPIList('/organization/certificates', (ConversationCursorPage), resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    delete(certificateID, options) {
        return this._client.delete(path `/organization/certificates/${certificateID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
    ...
    activate(body, options) {
        return this._client.getAPIList('/organization/certificates/activate', (Page), resolveResourceRequestOptions(options, (options) => ({
            body,
            method: 'post',
            ...options,
            __security: { adminAPIKeyAuth: true },
    ...
    deactivate(body, options) {
        return this._client.getAPIList('/organization/certificates/deactivate', (Page), resolveResourceRequestOptions(options, (options) => ({
            body,
            method: 'post',
            ...options,
            __security: { adminAPIKeyAuth: true },
