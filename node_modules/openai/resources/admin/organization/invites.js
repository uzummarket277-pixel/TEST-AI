...
class Invites extends resource_1.APIResource {
    ...
    retrieve(inviteID, options) {
        return this._client.get((0, path_1.path) `/organization/invites/${inviteID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
    list(query = {}, options) {
        ...
        query = query;
        return this._client.getAPIList('/organization/invites', (pagination_1.ConversationCursorPage), resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    delete(inviteID, options) {
        return this._client.delete((0, path_1.path) `/organization/invites/${inviteID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
