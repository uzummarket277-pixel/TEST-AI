...
class SpendAlerts extends resource_1.APIResource {
    ...
    retrieve(alertID, options) {
        return this._client.get((0, path_1.path) `/organization/spend_alerts/${alertID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
    ...
    update(alertID, body, options) {
        return this._client.post((0, path_1.path) `/organization/spend_alerts/${alertID}`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    list(query = {}, options) {
        ...
        query = query;
        return this._client.getAPIList('/organization/spend_alerts', (pagination_1.ConversationCursorPage), resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    ...
    delete(alertID, options) {
        return this._client.delete((0, path_1.path) `/organization/spend_alerts/${alertID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            __security: { adminAPIKeyAuth: true },
        })));
    }
