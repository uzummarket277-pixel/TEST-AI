...
export class Sessions extends APIResource {
    ...
    accept(sessionID, body, options) {
        return this._client.post(path `/live/sessions/${sessionID}/accept`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
    ...
    downloadRecording(sessionID, options) {
        return this._client.get(path `/live/sessions/${sessionID}/content`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
    ...
    fork(sessionID, body, options) {
        return this._client.post(path `/live/sessions/${sessionID}/fork`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            __security: { bearerAuth: true },
        })));
    ...
    hangup(sessionID, options) {
        return this._client.post(path `/live/sessions/${sessionID}/hangup`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
            __security: { bearerAuth: true },
        })));
    ...
    refer(sessionID, body, options) {
        return this._client.post(path `/live/sessions/${sessionID}/refer`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
            __security: { bearerAuth: true },
    ...
    reject(sessionID, body, options) {
        return this._client.post(path `/live/sessions/${sessionID}/reject`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
            __security: { bearerAuth: true },
