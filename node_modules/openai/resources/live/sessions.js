...
class Sessions extends resource_1.APIResource {
    ...
    accept(sessionID, body, options) {
        return this._client.post((0, path_1.path) `/live/sessions/${sessionID}/accept`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
    ...
    downloadRecording(sessionID, options) {
        return this._client.get((0, path_1.path) `/live/sessions/${sessionID}/content`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
    ...
    fork(sessionID, body, options) {
        return this._client.post((0, path_1.path) `/live/sessions/${sessionID}/fork`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            __security: { bearerAuth: true },
        })));
    ...
    hangup(sessionID, options) {
        return this._client.post((0, path_1.path) `/live/sessions/${sessionID}/hangup`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
            __security: { bearerAuth: true },
        })));
    ...
    refer(sessionID, body, options) {
        return this._client.post((0, path_1.path) `/live/sessions/${sessionID}/refer`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
            __security: { bearerAuth: true },
    ...
    reject(sessionID, body, options) {
        return this._client.post((0, path_1.path) `/live/sessions/${sessionID}/reject`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([{ Accept: '*/*' }, options?.headers]),
            __security: { bearerAuth: true },
