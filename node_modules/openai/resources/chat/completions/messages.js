...
class Messages extends resource_1.APIResource {
    list(completionID, query = {}, options) {
        ...
        query = query;
        return this._client.getAPIList((0, path_1.path) `/chat/completions/${completionID}/messages`, (pagination_1.CursorPage), resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
