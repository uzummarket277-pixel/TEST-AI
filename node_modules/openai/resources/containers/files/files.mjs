...
export class Files extends APIResource {
    ...
    create(containerID, body, options) {
        return this._client.post(path `/containers/${containerID}/files`, resolveResourceRequestOptions(options, (options) => maybeMultipartFormRequestOptions({ body, ...options, __security: { bearerAuth: true } }, this._client)));
    }
    /**
    ...
    retrieve(fileID, params, options) {
        ...
        return this._client.get(path `/containers/${container_id}/files/${fileID}`, resolveResourceRequestOptions(options, (options) => ({ ...options, __security: { bearerAuth: true } })));
    }
    list(containerID, query = {}, options) {
        ...
        query = query;
        return this._client.getAPIList(path `/containers/${containerID}/files`, (CursorPage), resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
    ...
    delete(fileID, params, options) {
        const { container_id } = params;
        return this._client.delete(path `/containers/${container_id}/files/${fileID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
