...
export declare class Files extends APIResource {
     ...
     */
    list(containerID: string, query?: (FileListParams & ({
    ...
    } | null | undefined)) | null | undefined, options?: RequestOptions): PagePromise<FileListResponsesPage, FileListResponse>;
    list(containerID: string, options?: {
