...
export class ContentProvenanceChecks extends APIResource {
     ...
     */
    create(body, options) {
        return this._client.post('/content_provenance_checks', resolveResourceRequestOptions(options, (options) => multipartFormRequestOptions({ body, ...options, __security: { bearerAuth: true } }, this._client)));
    }
}
