...
import { SendQueue, getMaxBufferedEvents, recordWebSocketError, rawByteLength, flattenRawData, isRecoverableClose, } from "../../internal/ws.mjs";
...
export function getWebSocketEventBytes(event) {
 ...
 * @internal
 */
export function getWebSocketEventPayload(event) {
