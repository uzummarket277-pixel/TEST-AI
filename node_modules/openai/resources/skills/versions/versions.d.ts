...
export declare class Versions extends APIResource {
     ...
     */
    list(skillID: string, query?: (VersionListParams & ({
    ...
    } | null | undefined)) | null | undefined, options?: RequestOptions): PagePromise<SkillVersionsPage, SkillVersion>;
    list(skillID: string, options?: {
