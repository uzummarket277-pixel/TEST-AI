...
export declare class Items extends APIResource {
     ...
     */
    list(conversationID: string, query?: (ItemListParams & ({
    ...
    } | null | undefined)) | null | undefined, options?: RequestOptions): PagePromise<ConversationItemsPage, ConversationItem>;
