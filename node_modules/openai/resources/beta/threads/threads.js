...
class Threads extends resource_1.APIResource {
     ...
     */
    create(body = {}, options) {
        return this._client.post('/threads', resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
    ...
    retrieve(threadID, options) {
        return this._client.get((0, path_1.path) `/threads/${threadID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            headers: (0, headers_1.buildHeaders)([{ 'OpenAI-Beta': 'assistants=v2' }, options?.headers]),
            __security: { bearerAuth: true },
        })));
    ...
    update(threadID, body, options) {
        return this._client.post((0, path_1.path) `/threads/${threadID}`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([{ 'OpenAI-Beta': 'assistants=v2' }, options?.headers]),
            __security: { bearerAuth: true },
    ...
    delete(threadID, options) {
        return this._client.delete((0, path_1.path) `/threads/${threadID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            headers: (0, headers_1.buildHeaders)([{ 'OpenAI-Beta': 'assistants=v2' }, options?.headers]),
            __security: { bearerAuth: true },
        })));
    ...
    createAndRun(body, options) {
        return this._client.post('/threads/runs', resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            headers: (0, headers_1.buildHeaders)([{ 'OpenAI-Beta': 'assistants=v2' }, options?.headers]),
