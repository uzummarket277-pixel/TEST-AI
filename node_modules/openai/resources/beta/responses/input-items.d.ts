...
export declare class InputItems extends APIResource {
     ...
     * ```
     */
    list(responseID: string, params?: (InputItemListParams & ({
    ...
    } | null | undefined)) | null | undefined, options?: RequestOptions): PagePromise<BetaResponseItemsPage, ResponsesAPI.BetaResponseItem>;
