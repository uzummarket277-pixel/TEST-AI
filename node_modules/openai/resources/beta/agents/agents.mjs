...
export class Agents extends APIResource {
    ...
    retrieve(agentID, options) {
        return this._client.get(path `/agents/${agentID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            headers: buildHeaders([{ 'OpenAI-Beta': 'agents=v1' }, options?.headers]),
            __security: { bearerAuth: true },
        })));
    ...
    update(agentID, body = {}, options) {
        return this._client.post(path `/agents/${agentID}`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            headers: buildHeaders([{ 'OpenAI-Beta': 'agents=v1' }, options?.headers]),
            __security: { bearerAuth: true },
    ...
    list(query = {}, options) {
        ...
        query = query;
        return this._client.getAPIList('/agents', (CursorPage), resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
            headers: buildHeaders([{ 'OpenAI-Beta': 'agents=v1' }, options?.headers]),
            __security: { bearerAuth: true },
    ...
    delete(agentID, options) {
        return this._client.delete(path `/agents/${agentID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            headers: buildHeaders([{ 'OpenAI-Beta': 'agents=v1' }, options?.headers]),
            __security: { bearerAuth: true },
        })));
