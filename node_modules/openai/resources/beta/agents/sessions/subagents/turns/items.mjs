...
export class Items extends APIResource {
    ...
    list(turnID, params, options) {
        ...
        return this._client.getAPIList(path `/agents/sessions/${session_id}/subagents/${subagent_id}/turns/${turnID}/items`, (CursorPage), resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
