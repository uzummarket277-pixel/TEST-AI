...
import { Credential, CredentialAuth, CredentialAuthCreateParam, CredentialAuthRotateParam, CredentialCreateParams, CredentialDeleteParams, CredentialDeleted, CredentialListParams, CredentialNetworking, CredentialNetworkingParam, CredentialRetrieveParams, CredentialUpdateParams, Credentials, CredentialsPage, McpOauthTokenEndpointAuth, McpOauthTokenEndpointAuthCreateParam, McpOauthTokenEndpointAuthRotateParam } from "./credentials.mjs";
...
export declare class Vaults extends APIResource {
    ...
    } | null | undefined)) | null | undefined, options?: RequestOptions): PagePromise<VaultsPage, Vault>;
    list(options?: {
