...
export class Credentials extends APIResource {
    ...
    create(vaultID, body, options) {
        return this._client.post(path `/vaults/${vaultID}/credentials`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
    ...
    retrieve(credentialID, params, options) {
        ...
        return this._client.get(path `/vaults/${vault_id}/credentials/${credentialID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            headers: buildHeaders([{ 'OpenAI-Beta': 'agents=v1' }, options?.headers]),
            __security: { bearerAuth: true },
        })));
    ...
    update(credentialID, params, options) {
        ...
        return this._client.post(path `/vaults/${vault_id}/credentials/${credentialID}`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            headers: buildHeaders([{ 'OpenAI-Beta': 'agents=v1' }, options?.headers]),
            __security: { bearerAuth: true },
    ...
    list(vaultID, query = {}, options) {
        ...
        query = query;
        return this._client.getAPIList(path `/vaults/${vaultID}/credentials`, (CursorPage), resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
            headers: buildHeaders([{ 'OpenAI-Beta': 'agents=v1' }, options?.headers]),
            __security: { bearerAuth: true },
    ...
    delete(credentialID, params, options) {
        const { vault_id } = params;
        return this._client.delete(path `/vaults/${vault_id}/credentials/${credentialID}`, resolveResourceRequestOptions(options, (options) => ({
            ...options,
            headers: buildHeaders([{ 'OpenAI-Beta': 'agents=v1' }, options?.headers]),
            __security: { bearerAuth: true },
        })));
