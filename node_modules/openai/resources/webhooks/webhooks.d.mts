...
export declare class Webhooks extends APIResource {
     ...
     * ```
     */
    update(webhookEndpointID: string, body?: WebhookUpdateParams | null | undefined, options?: RequestOptions): APIPromise<WebhookEndpoint>;
    /**
    ...
    } | null | undefined)) | null | undefined, options?: RequestOptions): PagePromise<WebhookEndpointsPage, WebhookEndpoint>;
    list(options?: {
     ...
     * ```
     */
    rotateSecret(webhookEndpointID: string, body?: WebhookRotateSecretParams | null | undefined, options?: RequestOptions): APIPromise<WebhookEndpointWithSecret>;
    /**
     ...
     * ```
     */
    test(webhookEndpointID: string, body: WebhookTestParams, options?: RequestOptions): APIPromise<WebhookEndpointTestResult>;
    /**
...
export declare namespace SafetyDeactivationIssuedWebhookEvent {
    interface Data {
        /**
...
export declare namespace SafetyWarningIssuedWebhookEvent {
    interface Data {
        /**
         * The safety case ID to pass to `GET /v1/safety/cases/{id}`.
         */
