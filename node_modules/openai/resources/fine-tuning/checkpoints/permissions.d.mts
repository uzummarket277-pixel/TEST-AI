...
export declare class Permissions extends APIResource {
     ...
     */
    retrieve(fineTunedModelCheckpoint: string, query?: (PermissionRetrieveParams & ({
    ...
    } | null | undefined)) | null | undefined, options?: RequestOptions): APIPromise<PermissionRetrieveResponse>;
    retrieve(fineTunedModelCheckpoint: string, options?: {
     ...
     * ```
     */
    list(fineTunedModelCheckpoint: string, query?: (PermissionListParams & ({
        [K in 'method' | 'path' | 'query' | 'body' | 'headers' | 'maxRetries' | 'stream' | 'timeout' | 'httpAgent' | 'fetchOptions' | 'signal' | 'idempotencyKey' | 'defaultBaseURL' | '__metadata' | '__binaryRequest' | '__binaryResponse' | '__streamClass' | '__security' | '__synthesizeEventData']?: never;
    } | null | undefined)) | null | undefined, options?: RequestOptions): PagePromise<PermissionListResponsesPage, PermissionListResponse>;
    list(fineTunedModelCheckpoint: string, options?: {
        [K in 'headers' | 'maxRetries' | 'timeout' | 'signal' | 'idempotencyKey' | 'query']?: RequestOptions[K];
    } & {
        [K in 'method' | 'path' | 'body' | 'stream' | 'httpAgent' | 'fetchOptions' | 'defaultBaseURL' | '__metadata' | '__binaryRequest' | '__binaryResponse' | '__streamClass' | '__security' | '__synthesizeEventData']?: never;
