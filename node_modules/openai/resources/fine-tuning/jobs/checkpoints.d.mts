...
export declare class Checkpoints extends APIResource {
     ...
     * ```
     */
    list(fineTuningJobID: string, query?: (CheckpointListParams & ({
    ...
    } | null | undefined)) | null | undefined, options?: RequestOptions): PagePromise<FineTuningJobCheckpointsPage, FineTuningJobCheckpoint>;
    list(fineTuningJobID: string, options?: {
