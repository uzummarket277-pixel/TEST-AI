...
class Checkpoints extends resource_1.APIResource {
    list(fineTuningJobID, query = {}, options) {
        ...
        query = query;
        return this._client.getAPIList((0, path_1.path) `/fine_tuning/jobs/${fineTuningJobID}/checkpoints`, (pagination_1.CursorPage), resolveResourceRequestOptions(options, (options) => ({
            query,
            ...options,
