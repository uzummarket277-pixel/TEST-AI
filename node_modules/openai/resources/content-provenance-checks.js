...
class ContentProvenanceChecks extends resource_1.APIResource {
     ...
     */
    create(body, options) {
        return this._client.post('/content_provenance_checks', resolveResourceRequestOptions(options, (options) => (0, uploads_1.multipartFormRequestOptions)({ body, ...options, __security: { bearerAuth: true } }, this._client)));
    }
}
