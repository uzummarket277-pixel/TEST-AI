...
class Uploads extends resource_1.APIResource {
     ...
     */
    create(body, options) {
        return this._client.post('/uploads', resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
    ...
    cancel(uploadID, options) {
        return this._client.post((0, path_1.path) `/uploads/${uploadID}/cancel`, resolveResourceRequestOptions(options, (options) => ({ ...options, __security: { bearerAuth: true } })));
    }
    /**
     * Completes the
    ...
    complete(uploadID, body, options) {
        return this._client.post((0, path_1.path) `/uploads/${uploadID}/complete`, resolveResourceRequestOptions(options, (options) => ({
            body,
            ...options,
            __security: { bearerAuth: true },
        })));
