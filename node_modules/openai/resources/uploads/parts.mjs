...
export class Parts extends APIResource {
    ...
    create(uploadID, body, options) {
        return this._client.post(path `/uploads/${uploadID}/parts`, resolveResourceRequestOptions(options, (options) => multipartFormRequestOptions({ body, ...options, __security: { bearerAuth: true } }, this._client)));
    }
}
