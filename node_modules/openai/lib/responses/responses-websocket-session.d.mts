import type { ResponsesEmitter } from "../../resources/responses/internal-base.mjs";
import type { WebSocketLike } from "../../internal/ws-adapter.mjs";
import { ResponsesWebSocketLane } from "./responses-websocket-lane.mjs";
export { ResponsesWebSocketLane } from "./responses-websocket-lane.mjs";
export type { ResponsesWebSocketEvent } from "./responses-websocket-lane.mjs";
 ...
 */
export declare class ResponsesWebSocketSession {
    #private;
    constructor(connection: ResponsesEmitter & {
     ...
     */
    lane(streamID?: string, limits?: {
        maxBufferedEvents?: number;
        maxBufferedBytes?: number;
    }): ResponsesWebSocketLane;
    close(): void;
}
//# sourceMappingURL=responses-websocket-session.d.mts.map