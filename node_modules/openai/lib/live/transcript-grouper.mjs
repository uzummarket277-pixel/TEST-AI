...
import { TranscriptGrouping } from "./transcript-grouping.mjs";
const SETTLE_MS = 50;
...
function normalizeTranscript(event) {
    ...
    typeof id !== 'string' ||
        ...
        endMs < startMs) {
        throw new OpenAIError('Invalid Live transcript delta: expected an event ID, text, and a nonnegative timed interval');
    }
...
export class TranscriptGrouper extends EventEmitter {
...
//# sourceMappingURL=transcript-grouper.mjs.map